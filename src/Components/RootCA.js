...
import { generatelocalcacert } from '../helper/userAPIcalls';
...
const RootCA = () => {
    ...
    const formUI = () => {
        ...
        <form style={{display: loading || msg ? "none": "block", marginBottom: "2rem"}}>
            ...
            <button type="submit" onClick={handleSubmit} className="btn btn-outline-success m-4">Generate Local CA Certificate</button> 
        ...
        <>
            <div className="card mb-4">
                <h4 className="card-header">
                    <b><span className="fa fa-user-secret"></span> Local CA Certificate </b>
                </h4>
                {
