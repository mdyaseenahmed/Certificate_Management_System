...
import { createSignedCertificate } from '../helper/userAPIcalls';
...
const SignedCert = () => {
    ...
    const formUI = () => {
        ...
        <form style={{display: loading || msg ? "none": "block", marginBottom: "2rem"}}>
            ...
            <button type="submit" onClick={handleSubmit} className="btn btn-outline-success m-4">Generate Signed Certificate</button> 
        ...
        <>
            <div className="card mb-4">
                <h4 className="card-header">
                    <b><span className="fa fa-university"></span> Signed Certificate </b>
                </h4>
                {
